...
<head>
	...
	{{-- <link rel="stylesheet" href="assets/css/johndoe.css"> --}}
     {{-- <link href="{{ asset('assets/css/johndoe.css') }}" rel="stylesheet"/> --}}
    {{-- /var/www/html/asistavec/resources/assets/css --}}
    @vite(['resources/assets/css/johndoe.css', 'resources/assets/js/johndoe.js'])
</head>
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                <h4 class="header-subtitle" >Bienvenido a</h4>
                <h1 class="header-title">ASISTAVEC</h1>
                <h6 class="header-mono" >Control de Asistencia a Eventos</h6>
                <button class="btn btn-primary btn-rounded"><i class="ti-printer pr-2"></i>Saber más...</button>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                {{-- <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="#about" class="nav-link">Unidades</a>
                    </li>
                    <li class="nav-item">
                        <a href="#resume" class="nav-link">Eventos</a>
                    </li>
                </ul>
